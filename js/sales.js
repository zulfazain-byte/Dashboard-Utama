/* ============================================================
   ...
   (Diperbaiki: sintaks aman, tidak ada error)
   ============================================================ */
...
(function () {
    ...
    function refreshStats() {
        ...
        const totalTrx = new Set(todaySales.map(s => s.transactionId || s.id)).size;
    ...
    async function processSale(e) {
        ...
        for (let item of items) {
            ...
            item.hargaJual = reCalc.hargaJual || item.hargaJual;
